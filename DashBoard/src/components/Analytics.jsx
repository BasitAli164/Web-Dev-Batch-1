...
const Analytics = ({ collapsed }) => {
  ...
  return (
    <div
      style={{
        marginLeft: collapsed ? 100 : 230, // Adjust layout based on collapse state
        paddingTop: 100,
    ...
    >
      ...
      >
        <div
          style={{
            width: '38%', // Adjust width for better responsiveness
        ...
        <div
          style={{
            width: '38%', // Adjust width for better responsiveness
            minWidth: '100px', // Set a minimum width for the charts
            height: 300,
          }}
        >
