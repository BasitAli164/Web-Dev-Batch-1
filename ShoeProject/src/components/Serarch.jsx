...
import { useCart } from './Context'; // Adjust the import based on your file structure
...
const Search = () => {
  const { item } = useCart(); // Get the products from context
  ...
  const handleSubmit = (e) => {
    ...
    const results = item.filter(product =>
